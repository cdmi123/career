...
<div class="container">
	<div class="row">	
        ...
        <div class="col-md-8">  
            ...
            <form method="post" id="product_info" enctype="multipart/form-data" action="<?php echo site_url(); ?>/company/Welcome/check">              
                <input type="hidden" name="company_id" value="<?php echo $arr['company_id']; ?>">                                                  
                <div class="form-group">                      
                  <input type="number"  name="payble_amount" id="payble_amount" class="form-control" value="<?php echo $arr['amount'] ?>" placeholder="Enter Payble Amount" required />
                </div>
                <div class="form-group">
                    <input type="text" name="product_info" id="product_info" class="form-control"  value="<?php echo $arr['email'] ?>"     Placeholder="Product info name" required />
                </div>
               <div class="form-group">                      
                  <input type="text"  name="customer_name" id="customer_name"  class="form-control" value="<?php echo $arr['company_name'] ?>" placeholder="Full Name (Only alphabets)" required/>
                </div>
                <div class="form-group">                                   
                  <input type="number"  name="mobile_number" id="mobile_number" value="<?php echo $arr['contact'] ?>"  class="form-control" placeholder="Mobile Number(10 digits)" required/>
                </div>
                <div class="form-group">                                   
                  <input type="email"  name="customer_email" id="customer_email"  value="<?php echo $arr['email'] ?>" class="form-control" placeholder="Email" required/>
                </div>
                <div class="form-group">
                  <textarea class="form-control" name="customer_address" id="customer_address" placeholder="Address" required><?php echo $arr['address']; ?></textarea>
                </div>
