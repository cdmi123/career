...
<head>
  ...
  <title>Job-Placemart | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url('home/index'); ?>"><b>Job-</b>Placemart</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg" style="color: red;"><?php echo @$msg; ?></p>
      ...
      <p class="mb-1">
        <a href="<?php echo site_url('company/forgot_password/index');?>">forgot password</a>
      </p>
      <p class="mb-0">
        <a href="<?php echo site_url('company/register/company_register') ?>">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
