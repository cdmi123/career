...
<script type="text/javascript">
    $(document).ready(function(){
      $('#select_country').change(function(){
        ...
        $.ajax({
          type:"post",
          url:"<?php echo site_url('admin/company/get_ajax_countrys');?>",
    ...
    $(document).ready(function(){
      $('#select_state').change(function(){
        ...
        $.ajax({
          type:"post",
          url:"<?php echo site_url('admin/company/get_ajax_states');?>",
     ...
     $(document).ready(function(){
      $('#select_city').change(function(){
        ...
        $.ajax({
          type:"post",
          url:"<?php echo site_url('admin/company/get_ajax_cities');?>",
